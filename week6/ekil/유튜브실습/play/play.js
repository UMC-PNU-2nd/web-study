...
const API_KEY = 'AIzaSyABgyuN29OLwEo6oOn2QcBSDxtcJg60ETg';

// function fetchVideo() {
//     fetch(`https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2C%20statistics&chart=mostPopular&maxResults=10&regionCode=kr&key=${API_KEY}`)
...
const dataFetch = async() => {
  const response = await fetch(`https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2C%20statistics&chart=mostPopular&maxResults=10&regionCode=kr&key=${API_KEY}`);
